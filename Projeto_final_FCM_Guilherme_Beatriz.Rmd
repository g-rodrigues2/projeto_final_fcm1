...
Nesta rodada de análises, vamos considerar as variáveis numéricas presentes no *dataset*. A priori vamos analisar a distribuição da faixa etária dos pacientes. Temos que

```{r}
# Histograma
ggplot() +
  geom_histogram(data = dados, aes(x = age, fill = "Não"), binwidth = 4, color = "black", alpha = 0.6) +
  geom_histogram(data = subset(dados, diabetes == 1), aes(x = age, fill = "Sim"), binwidth = 4, color = "black", alpha = 0.6) +
...
# Histograma
ggplot() +
  geom_histogram(data = dados, aes(x = bmi, fill = "Não"), binwidth = 4, color = "black", alpha = 0.6) +
  geom_histogram(data = subset(dados, diabetes == 1), aes(x = bmi, fill = "Sim"), binwidth = 4, color = "black", alpha = 0.6) +
...
# Histograma
ggplot() +
  geom_histogram(data = dados, aes(x = HbA1c_level, fill = "Não"), binwidth = 0.5, color = "black", alpha = 0.6) +
  geom_histogram(data = subset(dados, diabetes == 1), aes(x = HbA1c_level, fill = "Sim"), binwidth = 0.5, color = "black", alpha = 0.6) +
  labs(x = "IMC", y = "Contagem", fill = "Diabetes") +
  scale_fill_manual(values = c("Não" = "#88CCEE", "Sim" = "#CC6677")) +
...
ggplot() +
  geom_histogram(data = dados, aes(x = blood_glucose_level, fill = "Não"), 
                 binwidth = 20, color = "black", alpha = 0.6) +
...
# Scatterplot
ggplot(dados, aes(x = blood_glucose_level, y = HbA1c_level, fill = factor(diabetes))) +
  geom_point(shape = 21, size = 2) +
  labs(x = "Nível de glicose", y = "Nível de HbA1c", fill = "Diabetes") +
  ggtitle("Nível de glicose por Nível de HbA1c") +
  scale_fill_manual(values = c("#88CCEE", "#CC6677"),
                    breaks = c(0,1), labels = c("Não","Sim")) +
  theme()
